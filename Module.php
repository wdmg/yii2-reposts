...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        ...
        if (Yii::$app instanceof \yii\console\Application)
            $this->controllerNamespace = 'wdmg\reposts\commands';
    ...
    {
        Yii::$app->i18n->translations['app/modules/reposts'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'sourceLanguage' => 'en-US',
            'basePath' => '@vendor/wdmg/yii2-reposts/messages',
        ...
        $this->name = Yii::t('app/modules/reposts', $this->name);
        $this->description = Yii::t('app/modules/reposts', $this->description);
    }

    public static function t($category, $message, $params = [], $language = null)
    {
        return Yii::t('app/modules/reposts' . $category, $message, $params, $language);
    }
    ...
    public function dashboardNavItems()
    {
        return [
            'label' => $this->name,
            'url' => [$this->routePrefix . '/reposts/'],
            'active' => in_array(\Yii::$app->controller->module->id, ['reposts'])
        ];
    }
}